...
gamepadManager.getGamepad2().getRightTrigger().setPressedCommand(
        ...
        gamepadManager.getGamepad2().getDpadRight().setReleasedCommand(Extend.INSTANCE::highbasket);
        gamepadManager.getGamepad2().getDpadLeft().setReleasedCommand(Extend.INSTANCE::retract);
